...
class MainApplication : Application(), ReactApplication {
  ...
  override fun onCreate() {
    super.onCreate()
    // RN 0.76 merged the native libs into one libreactnative.so. The old
    // `false` overload still COMPILES and then dies on first launch, with
    // nothing in the gradle build to warn you.
